    ...
    <main className="text-white">
      <div className="flex min-h-screen flex-col items-center justify-between px-16 mt-3 gap-8">
        <section id="projects" className="max-w-full mt-5 mb-5">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            ...
            <div className="max-w-sm rounded overflow-hidden shadow-lg bg-black transition-transform ease-in-out hover:scale-105">
              <Image
                className="w-full"
                src="https://res.cloudinary.com/dyfmjmdb4/image/upload/v1686421978/jshop_wlaofv.png"
                width={300}
                height={300}
                alt="TODO List"
              />
              <div className="px-6 py-4">
                <div className="font-bold text-xl mb-2">JShop</div>
                <p className="text-white-700 text-base">
                  This application built with React, Vite and Tailwindcss
                  simulates a virtual ecommerce store in which you can interact
                  by adding products to the shopping cart, previewing and
                  searching.
                </p>
                <div className="flex gap-4">
                  <Link
                    href="https://github.com/jcruzbravo/ecommerce-react-vite-tailwind"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="underline"
                  >
            ...
            <div className="max-w-sm rounded overflow-hidden shadow-lg bg-black transition-transform ease-in-out hover:scale-105">
              <Image
                className="w-full"
                src="https://res.cloudinary.com/dyfmjmdb4/image/upload/v1686422013/react-shop_yasfam.png"
                width={300}
                height={300}
                alt="React Shop"
              />
              <div className="px-6 py-4">
                <div className="font-bold text-xl mb-2">React Shop</div>
                <p className="text-white-700 text-base">
                  This application built with React, HTML and CSS simulates a
                  virtual ecommerce store in which you can interact by adding
                  products to the shopping cart, previewing and searching.
                </p>
                <div className="flex gap-4">
                  <Link
                    href="https://github.com/jcruzbravo/react-shop"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="underline"
                  >
        ...
        <section id="about" className="max-w-md mt-8 mb-5">
          <h2 className="m-3 text-center font-bold text-2xl mt-5 mb-5">
            About me
          </h2>
          <p className="text-lg">
        ...
        >
          ...
          <div className="frontend-skills flex flex-col items-center justify-center gap-4">
            <h3>Frontend</h3>
          ...
          <div className="backend-skills flex flex-col items-center justify-center gap-4">
            <h3>Backend</h3>
            <div className="flex justify-center items-center gap-4">
              <div>
                <Image
          ...
          <div className="tools-skills flex flex-col justify-center items-center gap-4">
            <h3>Tools</h3>
            <div className="flex justify-center items-center gap-4">
              <div>
          ...
          <div className="data-base-skills flex flex-col justify-center items-center gap-4">
            <h3>Data Base</h3>
            <div className="flex justify-center items-center gap-4">
            <div>
